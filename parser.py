...
class KParseArgs():
    ...
    def __init__(self):
        ...
        self.parser.add_argument("--alpha", help="test size", action='store', nargs='?', default=0.2,
                            type=float)    
        self.parser.add_argument("--save", help="save or not", action='store', nargs='?', default=False,
                            type=bool)    
